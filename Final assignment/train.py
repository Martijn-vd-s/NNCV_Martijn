...
class OHEMLoss(nn.Module):
    ...
    def forward(self, pred, target):
        ...
        per_pixel = F.cross_entropy(pred, target, ignore_index=self.ignore, reduction="none")
        ...
        with torch.no_grad():
            ...
            if valid_loss < best_valid_loss:
                ...
                current_best_path = os.path.join(
                    output_dir, f"best_model-epoch={epoch:04}-val_loss={valid_loss:.4f}.pt"
                )
